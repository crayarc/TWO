...
<div class="inner-container">
		<h3>Server / P.F. Changs</h3>
    <p class="date"><i class="fa fa-calendar fa-fw w3-margin-right"></i>June 2016 - May 2017</p>
...
<div class="inner-container">
    ...
    <p class="date"><i class="fa fa-calendar fa-fw w3-margin-right"></i>May 2015 - Aug 2016</p>
        <p>Scan game tickets insuring that the proper ticket is being used to gain entry</p>
        <p>Assist fans in locating their ticketed seats</p>
...
<div class="inner-container">
    ...
    <p class="date"><i class="fa fa-calendar fa-fw w3-margin-right"></i>Nov 2013 - Aug 2014</p>
        <p>In control of opening/closing the store and taking the deposit.</p>
        <p>Using communication skills to help customers with what they are looking for</p>
        <p>Working together with a team in order to achieve objectives.</p>
        <p>Sell approximately $9,000 worth of merchandise and 300 tickets monthly.</p>
        <br>
      </div>
</div>
</div>
